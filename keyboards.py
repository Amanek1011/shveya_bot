...
def get_main_menu_keyboard(job: str):
    """job - это строка из БД"""
    # Нормализуем должность СИНХРОННО
    normalized_job = normalize_job_sync(job)

    job_actions = {
        'Закрой': ['Новая запись', 'Управление пользователями', 'Управление партиями', 'Все партии'],
        '4-х': ['Начать работу', 'Сменить партию', 'Моя статистика'],
        'Распаш': ['Начать работу', 'Сменить партию', 'Моя статистика'],
        'Бейка': ['Начать работу', 'Сменить партию', 'Моя статистика'],
        'Строчка': ['Начать работу', 'Сменить партию', 'Моя статистика'],
        'Горло': ['Начать работу', 'Сменить партию', 'Моя статистика'],
        'Утюг': ['Начать работу', 'Сменить партию', 'Моя статистика'],
        'OTK': ['Начать работу', 'Сменить партию', 'Моя статистика'],
        'Упаковка': ['Начать работу', 'Сменить партию', 'Моя статистика']
    }
