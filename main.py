...
from handlers.zakroi import (
    ...
    new_party_command, new_party_callback
)
...
from handlers.user_management import (
    user_management_start, user_management_action,
...
from handlers.party_management import (
    party_management_start, party_management_action,
...
# Закрой
dp.callback_query.register(zakroi_start, F.data == "zakroi")
